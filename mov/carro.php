...
<link rel="icon" href="images/iconos_01.ico">
...
<a href="#">
Precio Total: <?php total_price(); ?>, Articulos Totales <?php items(); ?>
</a>
...
<img src="images/logo-small1.png" alt="computerfever logo" class="visible-xs" >
...
<span> <?php items(); ?> Articulos Comprados </span>
...
<p class="text-muted" > Ventas <?php echo $count; ?> item(s) de entradas. </p>
...
<input class="btn btn-primary" type="submit" name="apply_coupon" value="Aplicar cupon" >
...
<i class="fa fa-chevron-left"></i> Continue añadiendo
...
Procesar pago <i class="fa fa-chevron-right"></i>
...
<p class="text-muted">
Sus reservaciones son bien protegidas
</p>
